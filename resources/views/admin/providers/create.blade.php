...
@section('content')
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-extrabold text-gray-900">Add Provider</h1>
    </div>
    <form method="POST" action="{{ route('admin.providers.store') }}"
        ...
        <div>
            ...
            <textarea name="notes" rows="3" placeholder="Any additional notes…"
                      class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 transition resize-none">{{ old('notes') }}</textarea>
