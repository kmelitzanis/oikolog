        ...
        <div class="pt-2 border-t border-gray-100 dark:border-slate-700">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <input type="text" name="email_from_pattern" value="{{ old('email_from_pattern', $provider->email_from_pattern) }}"
                           placeholder="@dei\.gr$"
                ...
                <div>
                    ...
                    <input type="text" name="email_subject_pattern" value="{{ old('email_subject_pattern', $provider->email_subject_pattern) }}"
                ...
                <div>
                    ...
                    <input type="text" name="email_amount_pattern" value="{{ old('email_amount_pattern', $provider->email_amount_pattern) }}"
